...
<head>
    ...
    <link rel="stylesheet" href="../assets/plugins/select2/dist/css/select2-bootstrap.min.css">
                ...
                <div class="panel-body wrapper-lg">
                    ...
                    <div class="panel panel-default wizard">
                        ...
                        <div class="step-content clearfix">
                            ...
                            if ($step == 1) { ?>
                                <div class="step-pane <?= $step1 ?>" id="step1">
                                    ...
                                    if (!is_writeable($uploads)) {
                                        $error = TRUE;
                                        echo "<div class='alert alert-danger'>The Uploads Folder (uploads) is not writeable!</div>";
                                    } else {
                                        echo "<div class='alert alert-success'><i class='fa fa-check-circle'></i> Uploads is writeable!</div>";
                                    }
                                    if (!is_writeable($filemanager)) {
                                        $error = TRUE;
                                        echo "<div class='alert alert-danger'>The Filemanager Folder (filemanager) is not writeable!</div>";
                                    } else {
                                        echo "<div class='alert alert-success'><i class='fa fa-check-circle'></i> Filemanager is writeable!</div>";
                                    }
                            ...
                            <hr />
                            <?php if ($debug != '') { ?>
                                <p class="sql-debug-alert text-success text-center" style="margin-bottom:20px;"><?php echo $debug; ?></p>
                            <?php } ?>
                            <?php
                            ...
                            <?php if ($step == 2) { ?>
                                <div class="step-pane <?= $step2 ?>" id="step2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="your envato username" name="envato_username">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Support Email</label>
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="your_support_email@gmail.com" name="support_email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" name="purchase_code">
                            ...
                            <?php if ($step == 3) { ?>
                                <div class="step-pane <?= $step3 ?>" id="step3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" value="localhost" placeholder="localhost" name="hostname">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Database Name</label>
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="db_crm" name="database">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="db_crm_user" name="db_username">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="password" class="form-control" placeholder="crm@!@@" name="db_password">
                                        </div>
                                    </div>
                            ...
                            <?php if ($step == 4) { ?>
                                <div class="step-pane <?= $step4 ?>" id="step4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="John Doe" name="admin_fullname">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="johndoe" name="admin_username">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="email" class="form-control" value="<?= $_POST['support_email'] ?>" placeholder="admin@unique_coder.com" name="admin_email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" placeholder="unique_coder" name="company_name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="email" class="form-control" placeholder="info@unique_coder.com" name="company_email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <select name="timezone" class="form-control select_box" style="width: 100%" required>
                                                <?php foreach ($this->get_timezones_list() as $timezone => $description) { ?>
                                                    <option value="<?php echo $timezone; ?>"><?php echo $description; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            ?>
                                ...
                                <p>Please delete the install directory and login as administrator at <a href="<?php echo $base_url; ?>login" target="_blank"><?php echo $base_url; ?>login</a></p>
                                <p><b>Remember:</b></p>
                                <ul class="list-unstyled">
                                    <li>Administrators needs to login at <a href="<?php echo $base_url; ?>login" target="_blank"><?php echo $base_url; ?>
                                            login</a></li>
                                </ul>
                                <hr />
                            <?php } ?>
