...
<div class="row mb">
    ...
    <div class="col-sm-8">
        ...
        <?php if ($this->invoice_model->get_invoice_cost($invoice_info->invoices_id) > 0) { ?>
            <a class="btn btn-success mr-sm" href="<?= base_url() ?>client/invoice/manage_invoice/invoice_history/<?= $invoice_info->invoices_id ?>"><?= lang('invoice_history') ?></a>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu animated zoomIn">
                    ...
                    foreach ($all_payment as $key => $payment) {
                        ...
                        if ($invoice_info->$allow_gateway == 'Yes') {
                            $modal = '';
                        ...
                        <tr>
                            ...
                            <?php if (!empty($edited) || !empty($deleted)) { ?>
                                <td>
                                    ...
                                    <?php } ?>
                                    <a data-toggle="tooltip" data-placement="top" href="<?= base_url() ?>client/invoice/send_payment/<?= $v_payments_info->payments_id . '/' . $v_payments_info->amount ?>" title="<?= lang('send_email') ?>" class="btn btn-xs btn-success">
                                        <i class="fa fa-envelope"></i> </a>
                                    <a data-toggle="tooltip" data-placement="top" href="<?= base_url() ?>client/invoice/payments_pdf/<?= $v_payments_info->payments_id ?>" title="<?= lang('pdf') ?>" class="btn btn-xs btn-warning">
