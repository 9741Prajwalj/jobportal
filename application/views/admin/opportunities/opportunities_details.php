...
$all_tender =  $this->db->where(array('opportunities_id'=> $opportunity_details->opportunities_id,'deletion_indicator'=>0))->order_by('tender_id', 'DESC')->get('tbl_tenders')->result();
// print_r($all_tender);
// exit();
?>
<div class="container" style="margin:10px">
    <button class="btn btn-primary" onclick="window.location.href='<?= base_url('/admin/leads') ?>'">
        View Lead
    </button>
</div>
<div class="row">
    <div class="col-sm-2">
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            ...
            <li class="<?= $active == 10 ? 'active' : '' ?>"><a href="#tender"
                                                               data-toggle="tab"><?= lang('Tender') ?><strong
    ...
    <div class="col-sm-10">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="border: 0;padding:0;">
                ...
                <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="call" style="position: relative;">
                    <div class="nav-tabs-custom ">
                        ...
                        <div class="tab-content bg-white">
                            ...
                            <div class="tab-pane <?= $sub_active == 3 ? 'active' : ''; ?>" id="create">
                ...
                <div class="tab-pane <?= $active == 10 ? 'active' : '' ?>" id="tender" style="position: relative;">
                    <div class="nav-tabs-custom ">
                        <!-- Tabs within a box -->
                        <ul class="nav nav-tabs">
                            <li class="<?= $sub_active == 1 ? 'active' : ''; ?>"><a href="#manage_tender"
                                                                                    data-toggle="tab"><?= lang('All Tender') ?></a>
                            </li>
                            <li class="<?= $sub_active == 2 ? 'active' : ''; ?>"><a href="#create_tender"
                        ...
                        <div class="tab-content bg-white">
                            <!-- ************** general *************-->
                            <div class="tab-pane <?= $sub_active == 1 ? 'active' : ''; ?>" id="manage_tender">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped" cellspacing="0"
                                        ...
                                        <thead>
                                        <tr>
                                            <th><?= lang('Tender Name') ?></th>
                                            <th><?= lang('Tender Budget') ?></th>
                                            <th><?= lang('Tender Start Date') ?></th>
                                            <th><?= lang('Tender End Date') ?></th>
                                            <th class="col-options no-sort"><?= lang('Action') ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        if (!empty($all_tender)):
                                            foreach ($all_tender as $v_tender): ?>
                                                <tr>
                                                   <td><?php echo $v_tender->tender_name;?></td>
                                                   <td><?php echo $v_tender->tender_budget;?></td>
                                                   <td><?php echo date('d-m-Y',strtotime($v_tender->tender_startdate));?></td>
                                                   <td><?php echo date('d-m-Y',strtotime($v_tender->tender_enddate));?></td>
                                                   <td>
                                                        <?= btn_edit('admin/opportunities/opportunity_details/' . $opportunity_details->opportunities_id . '/tender/' . $v_tender->tender_id) ?>
                                                        <a href="<?php echo base_url("admin/opportunities/delete_tender/" . $opportunity_details->opportunities_id . '/' . $v_tender->tender_id)?>" onclick=" return confirm('Are you sure you want to delete this tender?');"  title="DELETE" ><i class="btn btn-danger btn-xs fa fa-trash-o"></i> </a>
                                                   </td>
                                                </tr>
                                                <?php
                                            endforeach;
                            ...
                            <div class="tab-pane <?= $sub_active == 2 ? 'active' : ''; ?>" id="create_tender">
                                <?php if(!empty($tender_info)):?>
                                    <form role="form" enctype="multipart/form-data" id="form"
                                          action="<?php echo base_url(); ?>admin/opportunities/update_tender/<?= $opportunity_details->opportunities_id ?>/<?php echo $tender_info->tender_id;
                                          ?>" method="post" class="form-horizontal">
                                <?php else:?> 
                                    <form role="form" enctype="multipart/form-data" id="form"
                                          action="<?php echo base_url(); ?>admin/opportunities/save_tender/<?= $opportunity_details->opportunities_id ?>" method="post" class="form-horizontal">
                                <?php endif;?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <input type="text" required="" name="tender_name" value="<?php
                                                if (!empty($tender_info->tender_name)) {
                                                    echo $tender_info->tender_name;
                                                } 
                                                ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label"><?= lang('Budget') ?><span
                                                class="text-danger"> *</span></label>
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <input type="text" required="" name="tender_budget" value="<?php
                                                if (!empty($tender_info->tender_budget)) {
                                                    echo $tender_info->tender_budget;
                                                } 
                                                ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <input type="date" required="" name="tender_startdate"
                                                        min="<?php echo date('Y-m-d'); ?>" value="<?php
                                                if (!empty($tender_info->tender_startdate)) {
                                                    echo $tender_info->tender_startdate;
                                                } else {
                                                    echo date('Y-m-d');
                                                }
                                                ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <input type="date" required="" name="tender_enddate"
                                                        min="<?php echo date('Y-m-d'); ?>" value="<?php
                                                if (!empty($tender_info->tender_enddate)) {
                                                    echo $tender_info->tender_enddate;
                                                } else {
                                                    echo date('Y-m-d');
                                                }
                                                ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label"><?= lang('Eligibility') ?><span
                                                class="text-danger"> *</span></label>
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <textarea rows="2" required="" name="tender_eligibility"><?php if(!empty($tender_info->tender_eligibility)){echo $tender_info->tender_eligibility;}?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label"><?= lang('attachment') ?><span
                                                class="text-danger"> *</span></label>
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <input type="file"  name="tender_attachment">
                                            </div>
                                        </div>
