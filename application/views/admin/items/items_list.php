        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
                    ...
                    <table class="table table-striped DataTables bulk_table" id="DataTables" cellspacing="0"
                        ...
                        <tr>
                            ...
                            if (!empty($invoice_view) && $invoice_view == '2') {
                                ...
                                <th><?= lang('hsn_code') ?></th>
                            <?php } ?> -->
                            <th class="col-sm-1">Bus Length</th>
                            <th class="col-sm-1">No of seats</th>
                            <th class="col-sm-1">Vehicle weight</th>
                            <th class="col-sm-1">Battery</th>
                            <th class="col-sm-1">Battery capacity</th>
                            <th class="col-sm-1">Battery Temperature</th>
                            <th class="col-sm-1">Motor</th>
                            <th class="col-sm-1">Max Speed</th>
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">Bus Length <span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->bus_length;
                            }
                            ?>" name="bus_length" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->bus_remarks;
                            }
                            ?>" name="bus_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Number of Seats<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->total_seats;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->seats_remarks;
                            }
                            ?>" name="seats_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Gross Vehicle Weight<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->gross_vehicle_weight;
                            }
                            ?>" name="gross_vehicle_weight" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->gross_vehicle_remarks;
                            }
                            ?>" name="gross_vehicle_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Floor Height from Ground<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->floor_height;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->floor_remarks;
                            }
                            ?>" name="floor_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Battery<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->battery;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->battery_remarks;
                            }
                            ?>" name="battery_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Battery capacity (3 Pack/4 Pack)<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->capacity;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->capacity_remarks;
                            }
                            ?>" name="capacity_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Battery Temperature<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->temperature;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->temperature_remarks;
                            }
                            ?>" name="temperature_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label"> Motor<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->motor;
                            }
                            ?>" name="motor" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->motor_remarks;
                            }
                            ?>" name="motor_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Max Speed<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->max_speed;
                            }
                            ?>" name="max_speed" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->max_speed_remarks;
                            }
                            ?>" name="max_speed_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Charging Time<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($charging_time)) {
                                echo $items_info->charging_time;
                            }
                            ?>" name="charging_time" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->charging_time_remarks;
                            }
                            ?>" name="charging_time_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Mileage in One time charge<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->mileage;
                            }
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->mileage_remarks;
                            }
                            ?>" name="mileage_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Non-AC / AC<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->non_ac;
                            }
                            ?>" name="non_ac" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->non_ac_remarks;
                            }
                            ?>" name="non_ac_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">Homologation Approval<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->homologation;
                            }
                            ?>" name="homologation" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->homologation_remarks;
                            }
                            ?>" name="homologation_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-3 control-label">ITMS<span
                                    class="text-danger">*</span></label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->itms;
                            }
                            ?>" name="itms" required="">
                        </div>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->itms_remarks;
                            }
                            ?>" name="itms_remarks" placeholder = "Enter Remarks">
                        </div>
                    </div>
