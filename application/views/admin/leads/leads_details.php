...
<div class="row mt-lg">
    <div class="col-sm-2">
        ...
        if ($leads_details->converted_client_id == 0) {
            ...
            <li class="<?= $active == 12 ? 'active' : '' ?>"><a href="#tender"
    ...
    <div class="col-sm-10">
        ...
        <div class="tab-content" style="border: 0;padding:0;">
            ...
            <div class="tab-pane <?= $active == 12 ? 'active' : '' ?>" id="tender" style="position: relative;">
                    <div class="nav-tabs-custom ">
                        <!-- Tabs within a box -->
                        <ul class="nav nav-tabs">
                        ...
                        <div class="tab-content bg-white">
                                        ...
                                        if (!empty($all_tender)):
                                            foreach ($all_tender as $v_tender): ?>
                                                <tr>
                                                   ...
                                                   <td>
                                                        <?= btn_edit('admin/leads/leads_details/' . $leads_details->leads_id . '/tender/' . $v_tender->tender_lead_id) ?>
                                                        <a href="<?php echo base_url("admin/leads/delete_tender/" . $leads_details->leads_id . '/' . $v_tender->tender_lead_id)?>" onclick=" return confirm('Are you sure you want to delete this tender?');"  title="DELETE" ><i class="btn btn-danger btn-xs fa fa-trash-o"></i> </a>
                                                   </td>
                                                </tr>
                                                <?php
                                            endforeach;
                            ...
                            <div class="tab-pane <?= $sub_active == 2 ? 'active' : ''; ?>" id="create_tender">
                                <?php if(!empty($tender_info)):?>
                                    <form role="form" enctype="multipart/form-data" id="form"
                                          action="<?php echo base_url(); ?>admin/leads/update_tender/<?= $leads_details->leads_id ?>/<?php echo $tender_info->tender_lead_id;
                                          ?>" method="post" class="form-horizontal">
                                <?php else:?> 
                                    <form role="form" enctype="multipart/form-data" id="form"
                                          action="<?php echo base_url(); ?>admin/leads/save_tender/<?= $leads_details->leads_id ?>" method="post" class="form-horizontal">
                                <?php endif;?>
                                    <div class="form-group">
