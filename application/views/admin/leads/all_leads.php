                ...
                <form role="form" enctype="multipart/form-data" data-parsley-validate="" novalidate=""
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="field-1" class="col-sm-2 control-label" style="margin-top: 10px;"><?= lang('current_state') ?> <span
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php if (!empty($created)) { ?>
                                            <div class="input-group-addon"
                                                 ...
                                                 data-toggle="tooltip" data-placement="top">
                                                <!-- <a data-toggle="modal" data-target="#myModal"
                                                   href="<?= base_url() ?>admin/opportunities/opportunities_state_reason">
